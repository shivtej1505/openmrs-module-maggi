package org.openmrs.module.maggi.dataintegrity;
...
import org.openmrs.module.maggi.metadata.core.PatientIdentifierTypes;
...
public abstract class BasePatientRuleDefinition implements RuleDefinition<Patient> {
	...
	public String getHIVClinicNumber(Patient patient) {
		...
		PatientIdentifierType pit = patientService.getPatientIdentifierTypeByUuid(PatientIdentifierTypes.HIV_CARE_NUMBER
		        .uuid());
